...
public class DepartmentController {
	...
	@PutMapping("{roleId}/department/{departmentId}")
	@ResponseStatus(value = HttpStatus.OK)
	public void departmentRoleMapping(@PathVariable Integer roleId, @PathVariable Integer departmentId) {
		departmentService.assignDepartmentToRole(roleId, departmentId);
	}
